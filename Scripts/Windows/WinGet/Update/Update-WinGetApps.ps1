...
New-ScriptTaskSchedule -FolderPath "\$OrganizationName" -Name "UpdateMicrosoftStoreApps" -Description 'Update WinGet apps' -Path 'C:\Windows\System32\wscript.exe' -Argument $Files.PS1;
