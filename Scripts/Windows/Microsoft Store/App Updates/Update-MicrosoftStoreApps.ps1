...
New-ScriptTaskSchedule -FolderPath "\$OrganizationName" -Name "UpdateMicrosoftStoreApps" -Description 'Forces update Microsoft Store apps' -Path 'C:\Windows\System32\wscript.exe' -Argument $Files.PS1;
