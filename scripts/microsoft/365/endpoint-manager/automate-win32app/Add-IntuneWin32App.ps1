...
Function Upload-AzureStorageChunk
{
    ...
    # Construct URI.
    $Uri = ("{0}&comp=block&blockid={1}" -f $SasUri.Trim(), $Base64.Trim());
...
Function Add-IntuneWin32App
{
    ...
    # Get added app.
    $IntuneMobileApp = Get-IntuneMobileApp -ApiToken $ApiToken -AppId $IntuneWin32App.id;
